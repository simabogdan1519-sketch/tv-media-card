...
// ─── I18N ─────────────────────────────────────────────────────────────────────
const TV_I18N = {
  en: { on:"On", off:"Off", standby:"STANDBY", nowPlaying:"Now Playing", settings:"Settings", cardSettings:"Card Settings", general:"General", roomName:"Room / Device Name", brand:"TV Brand", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Google Cast entity — for title, progress & play state", none:"None", appearance:"Appearance", lang:"Language", apply:"Apply", idle:"Idle", unavailable:"Unavailable", launchApp:"Launch App"},
  ro: { on:"Pornit", off:"Oprit", standby:"STANDBY", nowPlaying:"Se redă acum", settings:"Setări", cardSettings:"Setări Card", general:"General", roomName:"Cameră / Dispozitiv", brand:"Brand TV", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Entitate Google Cast — titlu, progres și stare redare", none:"Niciunul", appearance:"Aspect", lang:"Limbă", apply:"Aplică", idle:"Inactiv", unavailable:"Indisponibil", launchApp:"Lansează Aplicație"},
  de: { on:"An", off:"Aus", standby:"STANDBY", nowPlaying:"Jetzt läuft", settings:"Einstellungen", cardSettings:"Karten-Einstellungen", general:"Allgemein", roomName:"Raum / Gerät", brand:"TV-Marke", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Google Cast Entität — Titel, Fortschritt & Wiedergabestatus", none:"Keine", appearance:"Aussehen", lang:"Sprache", apply:"Anwenden", idle:"Inaktiv", unavailable:"Nicht verfügbar", launchApp:"App starten"},
  fr: { on:"Allumé", off:"Éteint", standby:"VEILLE", nowPlaying:"En cours", settings:"Paramètres", cardSettings:"Paramètres carte", general:"Général", roomName:"Pièce / Appareil", brand:"Marque TV", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Entité Google Cast — titre, progression et état lecture", none:"Aucun", appearance:"Apparence", lang:"Langue", apply:"Appliquer", idle:"Inactif", unavailable:"Indisponible", launchApp:"Lancer App"},
  es: { on:"Encendido", off:"Apagado", standby:"EN ESPERA", nowPlaying:"Reproduciendo", settings:"Ajustes", cardSettings:"Ajustes de tarjeta", general:"General", roomName:"Habitación / Dispositivo", brand:"Marca TV", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Entidad Google Cast — título, progreso y estado", none:"Ninguno", appearance:"Apariencia", lang:"Idioma", apply:"Aplicar", idle:"Inactivo", unavailable:"No disponible", launchApp:"Lanzar App"},
  it: { on:"Acceso", off:"Spento", standby:"STANDBY", nowPlaying:"In riproduzione", settings:"Impostazioni", cardSettings:"Impostazioni scheda", general:"Generale", roomName:"Stanza / Dispositivo", brand:"Marca TV", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Entità Google Cast — titolo, avanzamento e stato", none:"Nessuno", appearance:"Aspetto", lang:"Lingua", apply:"Applica", idle:"Inattivo", unavailable:"Non disponibile", launchApp:"Avvia App"},
  pl: { on:"Włączony", off:"Wyłączony", standby:"CZUWANIE", nowPlaying:"Teraz odtwarzane", settings:"Ustawienia", cardSettings:"Ustawienia karty", general:"Ogólne", roomName:"Pokój / Urządzenie", brand:"Marka TV", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Encja Google Cast — tytuł, postęp i stan odtwarzania", none:"Brak", appearance:"Wygląd", lang:"Język", apply:"Zastosuj", idle:"Bezczynny", unavailable:"Niedostępny", launchApp:"Uruchom App"},
  hu: { on:"Bekapcsolva", off:"Kikapcsolva", standby:"KÉSZENLÉT", nowPlaying:"Most játszik", settings:"Beállítások", cardSettings:"Kártya beállítások", general:"Általános", roomName:"Szoba / Eszköz", brand:"TV márka", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Google Cast entitás — cím, haladás és lejátszási állapot", none:"Nincs", appearance:"Megjelenés", lang:"Nyelv", apply:"Alkalmaz", idle:"Tétlen", unavailable:"Nem elérhető", launchApp:"App indítása"},
  nl: { on:"Aan", off:"Uit", standby:"STANDBY", nowPlaying:"Nu afspelen", settings:"Instellingen", cardSettings:"Kaartinstellingen", general:"Algemeen", roomName:"Kamer / Apparaat", brand:"TV-merk", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Google Cast entiteit — titel, voortgang en afspeelstatus", none:"Geen", appearance:"Uiterlijk", lang:"Taal", apply:"Toepassen", idle:"Inactief", unavailable:"Niet beschikbaar", launchApp:"App starten"},
  pt: { on:"Ligado", off:"Desligado", standby:"ESPERA", nowPlaying:"A reproduzir", settings:"Definições", cardSettings:"Definições do cartão", general:"Geral", roomName:"Sala / Dispositivo", brand:"Marca TV", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Entidade Google Cast — título, progresso e estado", none:"Nenhum", appearance:"Aparência", lang:"Idioma", apply:"Aplicar", idle:"Inativo", unavailable:"Indisponível", launchApp:"Lançar App"},
  cs: { on:"Zapnuto", off:"Vypnuto", standby:"POHOTOVOST", nowPlaying:"Přehrává se", settings:"Nastavení", cardSettings:"Nastavení karty", general:"Obecné", roomName:"Místnost / Zařízení", brand:"Značka TV", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Entita Google Cast — název, průběh a stav přehrávání", none:"Žádný", appearance:"Vzhled", lang:"Jazyk", apply:"Použít", idle:"Nečinný", unavailable:"Nedostupný", launchApp:"Spustit App"},
  sk: { on:"Zapnuté", off:"Vypnuté", standby:"POHOTOVOSŤ", nowPlaying:"Práve hrá", settings:"Nastavenia", cardSettings:"Nastavenia karty", general:"Všeobecné", roomName:"Miestnosť / Zariadenie", brand:"Značka TV", entity:"Media Player (Remote)", castEntity:"Media Player (Cast)", castEntityHint:"Entita Google Cast — názov, priebeh a stav prehrávania", none:"Žiadny", appearance:"Vzhľad", lang:"Jazyk", apply:"Použiť", idle:"Nečinný", unavailable:"Nedostupný", launchApp:"Spustiť App"},
};
...
class TvMediaCard extends HTMLElement {
        ...
        <div class="modal">
          ...
          <div class="m-body">
            ...
            <div class="s-row">
              ...
              <select class="s-sel" id="iCast"><option value="">${this._t('none')}</option></select>
              <span style="font-size:10px;color:rgba(255,255,255,.28);margin-top:3px;">${this._t('castEntityHint')}</span>
            </div>
  ...
  _bindEvents() {
    ...
    this._$('btnApply').addEventListener('click', () => {
      ...
      this._cfg.cast_entity = cast || null;
  ...
  _openSettings() {
    ...
    this._$('iCast').innerHTML   = this._buildOpts(mpEntities, this._cfg.cast_entity || '', true);
  ...
  _updateCard() {
    ...
    // Cast entity — provides title, duration, position, play/pause state
    const castId   = this._cfg.cast_entity;
    const castObj  = castId ? this._hass.states[castId] : null;
    const castAttr = castObj?.attributes || {};
    const castS    = castObj?.state || '';
    const hasCast  = !!castObj && castS !== 'unavailable';

    // Play state: prefer cast if available, else fall back to remote
    const isPlaying = hasCast ? castS === 'playing' : s === 'playing';
    ...
    // App logo — always from remote (app_id is authoritative)
    ...
    // Now playing — prefer cast for title, remote for app name
    const friendlyApp = attr.app_name && !_isSystemString(attr.app_name) ? attr.app_name : '';
    sr.getElementById('npApp').textContent = showLogo ? (friendlyApp || rawApp).toUpperCase() : '';

    const mediaTitle = (hasCast ? castAttr.media_title : null) || attr.media_title || '';
    const mediaSub   = hasCast
      ? [castAttr.media_artist, castAttr.media_album_name].filter(Boolean).join(' — ')
      : '';
    sr.getElementById('npTitle').textContent = mediaTitle || (s === 'idle' ? this._t('idle') : '—');
    sr.getElementById('npSub').textContent   = mediaSub || this._t('nowPlaying');

    sr.getElementById('icPlay').style.display  = isPlaying ? 'none'  : 'block';
    sr.getElementById('icPause').style.display = isPlaying ? 'block' : 'none';

    // Progress — from cast if available
    cancelAnimationFrame(this._raf);
    const pAttr    = hasCast ? castAttr : attr;
    const pState   = hasCast ? castS    : s;
    const duration = pAttr.media_duration || 0;
    sr.getElementById('tot').textContent = this._fmt(duration);

    if (pState === 'playing' && duration > 0) {
      const snap = pAttr.media_position_updated_at ? (pAttr.media_position || 0) : 0;
      const ref  = pAttr.media_position_updated_at
        ? new Date(pAttr.media_position_updated_at).getTime()
        : Date.now();
      const tick = () => {
      ...
      const pos = pAttr.media_position || 0;
      const el  = sr.getElementById('pfill');
